...
public class UserManagerVerticleIT {
    ...
    public void test1InsertUser(TestContext context)
    {
        ...
        JsonObject config = new JsonObject().put("http", new JsonObject().put("auth", new JsonObject().put("db_name", dbName).put("connection_string", "mongodb://localhost:" + mongoPort).put("salt", SALT)));
