...
import {PositionReportChartData, PositionReportRow} from "./position.report.types";

const chartsURL: string = '/pr/latest';
const latestURL: string = '/pr/latest/:0/:1/:2/:3/:4/:5/:6/:7/:8';

@Injectable()
export class PositionReportsService extends AbstractHttpService<PositionReportRow[]| PositionReportChartData[]> {
