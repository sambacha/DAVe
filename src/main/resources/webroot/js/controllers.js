...
sandboxControllers.controller('MarginComponentDetail', ['$scope', '$routeParams', '$http', '$interval', '$filter',
    function($scope, $routeParams, $http, $interval, $filter) {
        ...
        $scope.url = 'http://172.23.39.44:9000/api/v1.0/mc-detail/' + $scope.clearer + '/' + $scope.member + '/' + $scope.account + '/' + $scope.class + '/' + $scope.ccy;
...
sandboxControllers.controller('TotalMarginRequirementOverview', ['$scope', '$routeParams', '$http', '$interval', '$filter',
    function($scope, $routeParams, $http, $interval, $filter) {
        ...
        $scope.url = 'http://172.23.39.44:9000/api/v1.0/tmr-overview/' + $scope.clearer + '/' + $scope.pool + '/' + $scope.member + '/' + $scope.account;
...
sandboxControllers.controller('TotalMarginRequirementDetail', ['$scope', '$routeParams', '$http', '$interval', '$filter',
    function($scope, $routeParams, $http, $interval, $filter) {
        ...
        $scope.url = 'http://172.23.39.44:9000/api/v1.0/tmr-detail/' + $scope.clearer + '/' + $scope.pool + '/' + $scope.member + '/' + $scope.account + '/' + $scope.ccy;
...
sandboxControllers.controller('MarginShortfallSurplusOverview', ['$scope', '$routeParams', '$http', '$interval', '$filter',
    function($scope, $routeParams, $http, $interval, $filter) {
        ...
        $scope.url = 'http://172.23.39.44:9000/api/v1.0/mss-overview/' + $scope.clearer + '/' + $scope.pool + '/' + $scope.member + '/' + $scope.clearingCcy;
...
sandboxControllers.controller('MarginShortfallSurplusDetail', ['$scope', '$routeParams', '$http', '$interval', '$filter',
    function($scope, $routeParams, $http, $interval, $filter) {
        ...
        $scope.url = 'http://172.23.39.44:9000/api/v1.0/mss-detail/' + $scope.clearer + '/' + $scope.pool + '/' + $scope.member + '/' + $scope.clearingCcy + '/' + $scope.ccy;
...
sandboxControllers.controller('TssCtrl', ['$scope', '$http', '$interval',
    function($scope, $http, $interval) {
        $scope.refresh = null;
        $scope.url = 'http://172.23.39.44:9000/api/v1.0/tss';
        $http.get($scope.url).success(function(data) {
            $scope.tss = data;
        });
